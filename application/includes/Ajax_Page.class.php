 ...
 * 12.reWrite()重写URL
 * 13.一定要确定PHP返回给ajax的数据
 * 14.URL路径中调用了JavaScript中setPage()方法
...
class Ajax_Page{
    ...
    private function first(){
        ...
        if($this->page==1){
            ...
            $str="<li><a href='javascript:setPage(\"$path\")'>1</li><li>...</li>";
    ...
    private function end(){
        ...
        if($this->page==$this->pageNum){
            ...
            $str="<li>...</li>
                <li><a href='javascript:setPage(\"$path\")'>".($this->pageNum)."</a></li>";
    ...
    private function prev(){
        ...
        if($this->page==1){
            ...
            $str="<li class='next'><a href='javascript:setPage(\"$path\")'>".$this->config['prev']."</a></li>";
        }
        return $str;
    }
    private function next(){
        ...
        if($this->page==$this->pageNum){
            ...
            $str="<li class='next'><a href='javascript:setPage(\"$path\")'>".$this->config['next']."</a></li>";
        }
        return $str;
    }
    /**
